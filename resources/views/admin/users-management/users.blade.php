...
<body>
            ...
            <div class="dataTables_wrapper">
                ...
                <div class="datatable-controls">
                    ...
                    <div class="datatable-actions">
                        ...
                        <button class="datatable-btn datatable-btn-secondary" data-bs-toggle="modal"
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="status-indicator {{ $user->status === 'Active' ? 'status-active' : 'status-inactive' }}">
                                        {{ $user->status }}
                                    </span>
                                </td>
                                <td>
                                    <div class="table-actions">
                                        ...
                                        <button class="table-action-btn archive-btn" data-id="{{ $user->id }}"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Archive">
                                            <i class="fas fa-archive"></i>
                                        </button>

                                        @if ($user->status === 'Active')
                                            <button class="table-action-btn disable-btn"
                                                data-id="{{ $user->id_number }}" data-bs-toggle="tooltip"
                                        ...
                                        @if ($user->status === 'Disabled')
                                            <button class="table-action-btn activate-btn"
                                                data-id="{{ $user->id_number }}" data-bs-toggle="tooltip"
                                        ...
                                        <button class="table-action-btn view-user-btn"
                                            data-id-number="{{ $user->id_number }}" data-bs-toggle="modal"
                                            data-bs-target="#userDetailsModal" title="View">
    ...
    <!-- Disable Modal -->
    <div class="modal fade" id="disableModal" tabindex="-1" aria-labelledby="disableModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="disableModalLabel">Are you sure?</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    You are about to disable this user.
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-danger" id="confirmDisable">Yes, disable it</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Activate Modal -->
    <div class="modal fade" id="activateModal" tabindex="-1" aria-labelledby="activateModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="activateModalLabel">Are you sure?</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-danger" id="confirmActivate">Yes, activate</button>
                </div>
            </div>
        </div>
    </div>
